...
NOTE: Replace `generic-package` with the actual name of this package `grub-live`.
...
`grub-live` requires [donations](https://www.kicksecure.com/wiki/Donate) to stay alive!
